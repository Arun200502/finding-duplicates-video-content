...
def hash_32b_to_16b(val32b):
    rightBits = val32b & 0xffff
    leftBits = val32b & 0xffff0000

    leftBits = leftBits >> 16

    return rightBits ^ leftBits

def generate_id(message: bytearray) -> bytearray:
    ...
    for message_block in blocks:
        ...
        hash_val = mmh3.hash(bytes(message),signed=False)

        #hash_object = hashlib.sha256(video_contents)
        ...
        return hash_32b_to_16b(hash_val)
...
def _capsigma1(num: int):
    """As defined in the specification."""
    num = (_rotate_right(num, 6) ^ _rotate_right(
        num, 11) ^ _rotate_right(num, 25))
    return num
...
# file1 = str(generate_id(video_contents)) + "\n"

# with open('video (1).mp4', 'rb') as f:
#     # Read the entire contents of the file
#     video_contents = f.read()

# file2 = str(generate_id(video_contents)) + "\n"

# with open('video.mp4', 'rb') as f:
#     # Read the entire contents of the file
#     video_contents = f.read()

# file3 = str(generate_id(video_contents)) + "\n"
